...
public class UpdateEquipmentRequest {
    ...
    @Schema(description = "装备名称", example = "equipment-01-new")
    @NotBlank(message = "设备名称不能为空")
    @Size(max = 128, message = "设备名称长度不能超过128位")
    private String name;

    @Schema(description = "装备描述", example = "更新后的说明")
    @Size(max = 500, message = "设备描述长度不能超过500位")
    private String description;

    @Schema(description = "颜色", example = "#13c2c2")
    @Size(max = 32, message = "color长度不能超过32位")
    private String color;

    @Schema(description = "图片路径", example = "equipment/20260426/b.png")
